...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='models/drunkards_odometry.pth', help='checkpoint to restore')
    parser.add_argument('--network', default='drunkards_odometry.drunkards_odometry', help='network architecture')
