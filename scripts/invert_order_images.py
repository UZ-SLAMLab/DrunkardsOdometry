...
file_extension_dict = {"color0": "jpg", "depth": "png"}

for data in ["color", "depth"]:
    input_image_folder = "/home/david/datasets/hamlyn_for_drunk_paper/test22/{}".format(data)
    output_image_folder = "/home/david/datasets/hamlyn_for_drunk_paper/test22_backward/{}".format(data)
