...
scene="00009"
num_images=8098
mesh_name="chunk000_group000_sub006_objectunknown000"
...
do
   ...
   $blender_exe -b $dataset_folder/$scene/$level/workspace.blend -P $render_scene_file -- -p $pose_folder -c $color_folder -n $num_images -m $mesh_name
done
