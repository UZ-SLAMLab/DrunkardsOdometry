...
from drunkards_odometry.blocks.layers import BackprojectDepth, Project3D
...
class ResnetEncoder(nn.Module):
    ...
    def forward(self, input_image):
        self.features = []
        x = input_image
        # x = (input_image - 0.45) / 0.225  # TODO: hace falta la normalizacion de ImageNet ? Igual si entrenamos todo de scratch esto sobra, pero si partimos de resnet preentrenado en Imgnet pues igual no sobra
